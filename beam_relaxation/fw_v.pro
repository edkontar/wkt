...
plot,Vel, F_v/sqrt(3.1416), xrange=[-40.,40.],xticks=6,Thick=2,/ylog,yrange=[1e-6,1], $
...
For j=0, N_elements(ImageCube[0,0,*])-1 DO write_gif,'FLS.gif', imageCube[*,*,j],r, g, b,/multiple
write_gif,'FLS.gif', /close
